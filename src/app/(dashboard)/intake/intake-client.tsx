        ...
        <DialogContent className="sm:max-w-md bg-white dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800">
          ...
          <div className="space-y-2.5 py-4">
            <div className="grid grid-cols-2 gap-2">
              <Button
                onClick={() => {
                  window.open(`/print/receipt/${createdTicketNumber}?format=thermal`, "_blank");
                }}
                className="bg-zinc-900 dark:bg-zinc-50 text-zinc-50 dark:text-zinc-900 font-bold flex items-center justify-center gap-1.5 text-xs py-2"
              >
              ...
              <Button
                onClick={() => {
                  window.open(`/print/receipt/${createdTicketNumber}?format=a4`, "_blank");
                }}
                variant="outline"
