        ...
        <div className="space-y-6 lg:col-span-1">
          <div className="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-850 dark:bg-zinc-900 space-y-4">
            ...
            <div className="space-y-3.5">
              ...
              <div className="flex justify-between items-center text-xs">
                <span className="text-zinc-500 dark:text-zinc-400 font-medium">Barang di Vendor BDG (Stok & Customer)</span>
              ...
              <div className="flex justify-between items-center text-xs">
                <span className="text-zinc-500 dark:text-zinc-400 font-medium">Barang di Vendor JKT (Stok & Customer)</span>
              ...
              <div className="flex justify-between items-center text-xs border-t border-zinc-100 dark:border-zinc-800 pt-2">
                <span className="text-zinc-500 dark:text-zinc-400 font-medium">Garansian Belum Diproses</span>
